...
const generateSource = require('../nunjucks/generate-source')
const getComponentConfig = require('../utils/get-component-config')
const highlightComponentSource = require('../utils/highlight-component-source')
...
module.exports = function (source) {
  ...
  nunjucksEnvironment.renderString(generatedSource, options, (error, render) => {
    ...
    const highlightedSource = highlightComponentSource(source)
    const highlightedTemplate = highlightComponentSource(store.state.templates[config.template])
    ...
    this.emitFile(`${outputName}/template.html`, highlightedTemplate)
