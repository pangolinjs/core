...
const getComponentDocs = require('../utils/get-component-docs.js')
...
module.exports = function (source) {
  const { NODE_ENV, PANGOLIN_ENV } = process.env
  ...
  const docs = getComponentDocs(`${this.context}/${sourceName}.md`)
