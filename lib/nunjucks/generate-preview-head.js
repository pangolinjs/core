...
module.exports = function () {
  ...
  if (process.env.PANGOLIN_ENV === 'build:dev') {
    if (store.state.modern) {
      head.push(`<script defer type="module" src="${base}js/runtime.modern.js"></script>`)
      head.push(`<script defer type="module" src="${base}js/vendors.modern.js"></script>`)
      head.push(`<script defer nomodule src="${base}js/runtime.js"></script>`)
      head.push(`<script defer nomodule src="${base}js/vendors.js"></script>`)
    } else {
  ...
  if (store.state.modern) {
    head.push(`<script defer type="module" src="${base}js/main.modern.js"></script>`)
    head.push(`<script defer nomodule src="${base}js/main.js"></script>`)
  } else {
